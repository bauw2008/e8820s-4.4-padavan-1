						...
						<div class="box well grad_colour_dark_blue">
                            ...
                            <ul class="nav nav-tabs" style="margin-bottom: 10px;">
								...
								<div class="row-fluid">
									...
									<p>AdGuard Home 是一款全网广告拦截与反跟踪软件。在您将其安装完毕后，它将保护您所有家用设备，同时您不再需要安装任何客户端软件。随着物联网与连接设备的兴起，掌控您自己的整个网络环境变得越来越重要。默认用户名密码均为admin，可在/etc/storage/adg.sh内修改。
									</p>
									AdGuardHome github主页<a href="AdGuardHome" target="blank"><i><u>https://github.com/AdguardTeam/AdGuardHome/</u></i></a>
									</div>
									...
									<table width="100%" align="center" cellpadding="4" cellspacing="0" class="table">
										...
										<tr>
											<th>WEB管理地址:</th>
											<td>
											<a href="http://<% nvram_get_x("", "lan_ipaddr"); %>:3000">http://<% nvram_get_x("", "lan_ipaddr"); %>:3000</a>
											</td>
										</tr>
